  ...
  return (
    <footer className="mt-auto bg-slate-900 text-slate-300">
      <div className="container-app py-12 grid gap-8 md:grid-cols-4">
        ...
        <div>
          <h2 className="text-white font-semibold mb-3 text-sm uppercase tracking-wide">Réserver</h2>
        ...
        <div>
          <h2 className="text-white font-semibold mb-3 text-sm uppercase tracking-wide">Légal</h2>
          <ul className="space-y-2 text-sm">
        ...
        <div>
          <h2 className="text-white font-semibold mb-3 text-sm uppercase tracking-wide">Contact</h2>
