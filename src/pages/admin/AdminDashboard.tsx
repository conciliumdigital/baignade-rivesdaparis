  ...
  return (
    <div>
      ...
      <div className="grid lg:grid-cols-2 gap-4 mt-6">
        ...
        <section className="card p-6">
          <h2 className="font-display font-bold mb-3">Répartition habitants / extérieurs <span className="text-xs font-normal text-slate-400">(données illustratives)</span></h2>
